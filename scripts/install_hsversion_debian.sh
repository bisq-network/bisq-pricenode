...
curl -s https://raw.githubusercontent.com/haveno-dex/haveno-pricenode/main/scripts/journalscraper_hsversion.sh > /tmp/journalscraper_hsversion.sh
...
curl -s https://raw.githubusercontent.com/haveno-dex/haveno-pricenode/main/scripts/collectd.conf.snippet > /tmp/collectd.conf.snippet
